...
function BarberSelectionContent() {
  ...
  useEffect(() => {
    ...
    const fetchBarbers = async () => {
      ...
      try {
        const serviceBarbers = await BookingService.getBarbersForService(serviceData.id);
    ...
    return (
      <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-xl font-semibold text-gray-900">Loading Barbers</h2>
    ...
    return (
      <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center px-4">
        <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 max-w-md w-full text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Unable to Load Barbers</h2>
          ...
          {selectedService && (
            <div className="mt-6 bg-white rounded-lg shadow-sm border p-4 max-w-md mx-auto">
              ...
              <div className="flex justify-center gap-4 mt-2 text-sm text-gray-600">
                ...
                <span>•</span>
                <span>{selectedService.duration > 10000 ? Math.round(selectedService.duration / 60000) : selectedService.duration} min</span>
              </div>
            </div>
          )}
        </div>
