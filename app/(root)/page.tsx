      ...
      <section className="flex flex-col md:grid grid-cols-2 gap-8 px-4 md:w-4xl container mx-auto">
        <div className="flex flex-col gap-2">
          ...
          <p>
            ...
            compliments your individual features. Through consultation we are
            dedicated to understand your unique preferences and tailor our
            recommendations to suit your specific needs. Whether you're seeking
            a new haircut, beard trim or grooming routine, we're here to guide
