...
export default function Home() {
  return (
    <main className="flex flex-col gap-20 pt-40">
      <section className="flex flex-col items-center gap-12 md:gap-20 px-4 mb-20 md:mb-40 container mx-auto">
        <h4>Built on discipline. Driven by meaning.</h4>
        <h2 className="text-center">OUR ETHOS</h2>

        <p>For those who live with depth, purpose, and discipline.</p>

        <div className="md:w-2/3 flex flex-col gap-8 md:gap-10">
          <p className="md:w-[400px]">
            We’re not here to survive. We’re here to reveal.
            <br />
            <br />
            Reveal character, purpose, presence. Every detail speaks — style,
            silence, motion. Nothing is random. Everything holds meaning.
            <br />
            <br />
            Discipline is self-respect. The body is a temple. The space is a
            sanctuary. The craft is a legacy.
            <br />
            <br />
            Simplicity, cleanliness, and intention are forms of quiet strength.
                    
            <br />
            <br />
            Each day begins with clarity. We move with gratitude, focus, and
            truth. Life is first spiritual — then practical.
            <br />
            <br />
            Support doesn’t need applause. Real presence doesn’t shout. It
            stands. It listens. It gives quietly.
            <br />
            <br />
            What we offer to others, we offer first to the soul.         
            <br />
            <br />
            Responsibility is honour. We choose the weight of purpose over the
            emptiness of convenience.
            <br />
            <br />
            We don’t follow trends. We follow truth.
            <br />
            <br />
                     This is not a race. There’s no finish line — only
            alignment. Step by step, with rhythm and vision, we become who we’re
            meant to be.         
            <br />
            <br />
            Freedom isn’t status. It’s the power to not be defined by what we
            own — but by who we are in silence.
            <br />
            <br />
            Peace is the real destination. Not applause. Not possessions. But
            the quiet knowing: I’ve become who I was meant to be.
          </p>
      ...
      <section className="flex flex-col gap-8 px-4 items-center bg-[#EFEFEF] py-10 pb-40">
        <div className="w-full md:w-max self-center">
          <Image
            ...
            width={500}
            height={500}
            alt="Want To Be Part Of The Team"
          />
        </div>

        <p>
          We partner closely with the most progressive companies in the world to
          improve their customer support operations.
        </p>
